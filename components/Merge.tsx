import { MERGED_OUTLINE_MODES, MergedOutlineMode, ParsedOutlineItem, getNamedDestinations, parseOutline, writeOutlineToDoc } from "@/lib/pdf-outline-helper";
...
export default function Merge() {
  ...
  return <><input aria-label="Add files"
    ...
    // ref={fileInputRef}
    type="file"
    multiple /><div className="border dark:border-slate-700 rounded-md p-2 bg-white dark:bg-slate-800">
    ...
    </div><div className="border dark:border-slate-700 rounded-md p-2 bg-white dark:bg-slate-800 mt-2">
